...
export class Init1685707483571 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "client_subscribe" ("client_id" integer NOT NULL, "subscribe_id" integer NOT NULL, CONSTRAINT "PK_80809b5aed343519fc2784a3a25" PRIMARY KEY ("client_id", "subscribe_id"))`);
